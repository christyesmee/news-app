...
# EXACT MODEL NAME (Do not change this string)
...
def analyze_news(articles):
    ...
    prompt = (
        ...
        "INSTRUCTIONS:\n"
        "1. Identify the top 3-4 most critical global themes.\n"
        ...
        "     (e.g., 'Protectionism', 'Realism', 'Soft Power').\n"
...
def send_email(html_content):
    ...
    final_email_body = template.safe_substitute(
    ...
    msg.attach(MIMEText(final_email_body, 'html'))
